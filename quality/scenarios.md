...
Este documento define los escenarios de calidad utilizados para evaluar la aplicación Pet Clinic Rest. Los escenarios de calidad ayudan a establecer criterios medibles para los requisitos no funcionales.
...
## Escenario Q3 — Robustez ante IDs inválidos en /api/pets/{id} (Robustness / Error Handling)
- Estímulo: se solicita GET /api/pets/{id} con valores inválidos (e.g., -1, 0, 999999, abc)
...
## Escenario Q4 — Respuesta “bien formada” en Veterinarios y Servicios (Data Shape Sanity)
- Estímulo: se solicita GET /api/vets
...
- Evidencia: evidence/week2/vets.json y vets_http_code.txt
