#!/bin/bash
# Suite de smoke test para la aplicación Pet Clinic REST

echo "Ejecutando smoke test para Pet Clinic REST..."
...
test_endpoint "/v3/api-docs" 200 "Endpoint de Especificación OpenAPI"
RESULT=$?
...
# Prueba 2: Obtener Mascotas
test_endpoint "/api/pets" 200 "Buscar mascotas"
RESULT=$?
TOTAL_TESTS=$((TOTAL_TESTS + 1))
if [ $RESULT -eq 0 ]; then
    PASSED_TESTS=$((PASSED_TESTS + 1))
...
# Prueba 3: Obtener Veterinarios y Servicios
test_endpoint "/api/vets" 200 "Endpoint de veterinarios y servicios"
RESULT=$?
TOTAL_TESTS=$((TOTAL_TESTS + 1))
if [ $RESULT -eq 0 ]; then
    PASSED_TESTS=$((PASSED_TESTS + 1))
...
# Prueba 4: Endpoint inválido (debería retornar 500)
test_endpoint "/invalid/endpoint" 500 "Endpoint inválido (prueba negativa)"
RESULT=$?
TOTAL_TESTS=$((TOTAL_TESTS + 1))
if [ $RESULT -eq 0 ]; then
    PASSED_TESTS=$((PASSED_TESTS + 1))
